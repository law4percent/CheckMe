...
5.  If True/False or true/false answers return as exactly "TRUE" or "FALSE" — never T or F.
...
9. If you found essay questions, never return or extract the full essay answer. Instead, return "essay_answer" for that question.
...
9.  If True/False or true/false answers return as exactly "TRUE" or "FALSE" — never T or F.
...
13. If you found essay questions, never return or extract the full essay answer. Instead, return "essay_answer" for that question.
14. CRITICAL: Sometimes, teacher provide clear instructions. If you find the instructions, read it carefully provided by the teacher on the test paper, as they may contain specific rules for how students should mark their answers. Follow those instructions precisely when determining the student's answer.
15. CRITICAL: Return raw JSON only. No explanation, no markdown, no code fences.
    The first character must be {{ and the last must be }}.
